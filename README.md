...
Make sure you've created another file called [.rab/FloraRec/**urles.py**](https://github.com/MLExpertBH0915/plant-identification-Django/blob/main/FloraRec/urls.py), then put the following content in it:
